...
class StyleTableViewController:UIViewController{
    let tb = UITableView()
...
extension StyleTableViewController:UITableViewDelegate,UITableViewDataSource{
