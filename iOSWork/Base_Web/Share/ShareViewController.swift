...
class ShareView: UIView {
    ...
    let vBg = UIView()
    let vContent = UIView()
    let btnShareToQQ = LayoutButton()
    let btnShareToWebchat = LayoutButton()
    let btnShareToFriends = LayoutButton()
    let btnCopyLing = LayoutButton()
    ...
    override init(frame: CGRect) {
        ...
        btnShareToQQ.layoutStyle = .TopImageBottomTitle
        ...
        btnShareToWebchat.layoutStyle = .TopImageBottomTitle
        ...
        btnShareToFriends.layoutStyle = .TopImageBottomTitle
        ...
        btnCopyLing.layoutStyle = .TopImageBottomTitle
