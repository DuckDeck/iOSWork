...
class NotifcationViewController: UIViewController {
    ...
    let btnSendNotif =  UIButton().title(title: "发通知").color(color: UIColor.black).bgColor(color: UIColor.yellow)
    let btnSendAsyncNotif =  UIButton().title(title: "非主线程通知").color(color: UIColor.black).bgColor(color: UIColor.yellow)
