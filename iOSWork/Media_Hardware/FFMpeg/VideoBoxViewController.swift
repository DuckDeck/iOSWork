...
import Foundation
class VideoBoxViewController: UIViewController {
...
extension VideoBoxViewController:SortFrameHandlerDelegate,VideoDecoderDelegate,FFmpegVideoDecoderDelegate{
    func getSortedVideoNode(_ videoDataRef: CMSampleBuffer) {
        ...
        print("Test margin \(pts - VideoBoxViewController.lastpts)")
        VideoBoxViewController.lastpts = pts
