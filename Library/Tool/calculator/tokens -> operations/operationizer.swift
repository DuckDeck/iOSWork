...
final class Operationizer {
    ...
    static func createOperations(fromTokens tokens: [Token]) -> CalcResult<[CalOperation]> {
    ...
    private func createOperations() -> [CalOperation] {
        var operations = [CalOperation]()
    ...
    private func createOperation(for token: Token) -> CalOperation? {
        switch token {
